...
const Projectcard = (params: ProjectcardProps) => {
  return (
      ...
      <div className="card  flex gap-12 flex-col md:flex-row width-screen  justify-center items-center text-center md:text-left md:justify-start overflow-hidden">
           <Image src={`${params.srcimg}`} width={500} height={500} alt="Project Image" className="w-100 h-60 object-contain border-white border-l-2 border-r-2 rounded-2xl hover:w-106 hover:h-62 transition-all duration-700 ease-in-out hover:shadow-[200px_0px_200px_-100px_white]" />
