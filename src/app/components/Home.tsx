      ...
      >
        ...
        >
          ...
          <div
            ...
            data-aos="fade-right"
          >
            <h2 className="text-3xl max-sm:text-xl max-sm:w-full">Hi, It&apos;s Me</h2>
            <h1 className="text-[50px] max-sm:text-3xl max-sm:w-full">Jatin Singh</h1>
            ...
            <p className="!mt-6 p-2" data-aos="fade-up" data-aos-delay="200">
            ...
            >
              ...
              >
                <BsYoutube className="hover:text-gray-300 !transition !duration-300 hover:scale-115" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <BsWikipedia className="hover:text-gray-300 !transition !duration-300 hover:scale-115" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <BsDiscord className="hover:text-gray-300 !transition !duration-300 hover:scale-115" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <BsGithub className="hover:text-gray-300 !transition !duration-300 hover:scale-115" />
              </a>
            </div>
