...
const Skills = () => {
  ...
  return (
    ...
    >
      <header>
        <h1 id="skills-heading" className="text-3xl text-white" data-aos="fade-up">
          Skills
        </h1>
        <div
          role="presentation"
          aria-hidden="true"
          className="w-50 h-1 bg-white rounded-full mt-3"
          data-aos="fade-right"
        ></div>
      </header>

      <h2
        className="text-2xl font-semibold text-white text-center p-10 rounded-4xl 
      ...
      <article
        ...
        className="text-lg leading-relaxed text-center md:pl-30 md:pr-30 
                   shadow-white md:p-20 pt-20 pb-20 p-7 rounded-4xl 
                   shadow-[0px_0px_50px_-35px_white]"
      >
        <p
          className="text-zinc-500 hover:text-white !transition-all duration-700 cursor-pointer p-3 leading-loose"
          data-aos="fade-up"
        >
      ...
      <p
        aria-label="Additional services offered"
        className="md:p-20 pt-20 pb-20 p-7 md:pl-30 md:pr-30 text-xl rounded-4xl leading-9 
      ...
      <div className="p-20 rounded-4xl shadow-[0px_0px_50px_-35px_white]">
        {/* Programming Skills */}
        <h2
          className="text-zinc-500 hover:text-white !transition-all duration-700 cursor-pointer flex items-center"
          data-aos="fade-right"
        >
          My Skills <BsArrowRightShort aria-hidden="true" />
        </h2>
        <ul
          role="list"
          aria-label="Programming skills"
          className="box1 flex flex-wrap gap-4 mt-4 justify-center items-center sm:items-start sm:justify-start"
        >
        ...
        {/* Other Tools */}
        <h2
          className="mt-12 text-zinc-500 hover:text-white !transition-all duration-700 cursor-pointer flex items-center"
          data-aos="fade-right" data-aos-delay="200"
        >
          Others <BsArrowRightShort aria-hidden="true" />
        </h2>
        <ul
          role="list"
        ...
        >
          AI Tools I Use <BsArrowRightShort aria-hidden="true" />
        </h2>
        <ul
          role="list"
          aria-label="AI tools"
